...
export default function Prism({
  ...
  useEffect(() => {
    ...
    // ── B&W: saturation = 0 maps every color to its luminance (pure grayscale)
    const SAT = 0;
    ...
    const fragment = /* glsl */ `
      ...
      void main() {
        ...
        // Saturation=0 → pure luminance (grayscale / B&W)
    ...
    const render = (t: number) => {
      ...
      if (animationType === "hover") {
        ...
        // "rotate" — identity matrix, wobble handled by uUseBaseWobble in shader
